...
<a href="https://pkg.go.dev/github.com/azber/openai-go"><img src="https://pkg.go.dev/badge/github.com/azber/openai-go.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/azber/openai-go" // imported as openai
)
```
...
```sh
go get -u 'github.com/azber/openai-go@v0.1.0-alpha.59'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/azber/openai-go/option).
...
import (
	...
	"github.com/azber/openai-go"
	"github.com/azber/openai-go/azure"
)
...
We are keen for your feedback; please open an [issue](https://www.github.com/azber/openai-go/issues) with questions, bugs, or suggestions.
